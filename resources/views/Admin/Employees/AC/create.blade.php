                            ...
                            <div class="card-body">
                                <div class="form-group-row">
                                    <div class="col-sm-9">
                                        ...
                                        <input type="text" name="firstname" class="form-control {{ $errors->has('firstname') ? ' is-invalid' : '' }}" id="fname" onkeypress="return !validNo(this,event)" placeholder="First Name" required>
