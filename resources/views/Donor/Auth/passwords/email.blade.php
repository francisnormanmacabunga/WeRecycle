              ...
              <div id="loginform">
                ...
                @endif
                  ...
                  <div class="row m-t-20">
                      <!-- Form -->
                      <form method="POST" class="col-12" action="{{ route('donor.password.email') }}" aria-label="{{ __('Reset Password') }}">
                        @csrf
                          <!-- email -->
                          ...
                          <div class="row m-t-20 p-t-20">
                              <div class="col-12">
                                  <a class="btn btn-danger btn-rounded" href="{{ url('/donor/login') }}" id="to-login" name="action">Back</a>
