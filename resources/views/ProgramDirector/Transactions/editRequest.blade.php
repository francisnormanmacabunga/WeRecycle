...
@section('content')
  ...
  <div class="row">
            <div class="col-md-12">
              ...
              <br/>
              <h5 align="left"><a href="{{ url('/programdirector/requests') }}">Back</a></h5>
              ...
              {!! Form::close() !!}
              <a class="btn btn-block btn-primary btn-lg btn-block" href="{{ url('/programdirector/requests') }}" role="button">Back</a>
            </div>
          </div>
