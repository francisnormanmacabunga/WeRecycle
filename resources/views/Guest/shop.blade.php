...
<body class="animsition">
	...
	<!-- Title page -->
	<section class="bg-img1 txt-center p-lr-15 p-tb-92" style="background-image: url({{asset('donor-design/images/fertilizer.jpg')}});">
	...
	<!-- Product -->
      ...
      <div class="flex-w flex-sb-m p-b-52">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
					<a href="{{url('/shop')}}" class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 how-active1">
						Shop fertilizers
					</a>
					<a href="{{url('/donation')}}" class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5">
						Donate
					</a>
				</div>
      </div>
